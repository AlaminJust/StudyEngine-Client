...
enum class BottomNavItem(
    ...
    HOME("dashboard", com.example.studyengine.R.string.nav_home, "home"),
    BOOKS("books", com.example.studyengine.R.string.nav_books, "book"),
    SESSIONS("sessions/today", com.example.studyengine.R.string.nav_sessions, "calendar_today"),
    SETTINGS("settings", com.example.studyengine.R.string.nav_settings, "settings")
}
