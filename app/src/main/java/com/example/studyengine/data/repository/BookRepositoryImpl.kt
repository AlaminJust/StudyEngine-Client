package com.example.studyengine.data.repository

import com.example.studyengine.core.util.Resource
import com.example.studyengine.data.local.dao.BookDao
import com.example.studyengine.data.local.dao.ChapterDao
import com.example.studyengine.data.local.dao.RecurrenceRuleDao
import com.example.studyengine.data.local.dao.StudyPlanDao
import com.example.studyengine.data.mapper.BookMapper
import com.example.studyengine.data.mapper.ChapterMapper
import com.example.studyengine.data.mapper.RecurrenceRuleMapper
import com.example.studyengine.data.mapper.StudyPlanMapper
import com.example.studyengine.data.remote.api.StudyEngineApi
import com.example.studyengine.data.remote.dto.IgnoreChapterRequestDto
