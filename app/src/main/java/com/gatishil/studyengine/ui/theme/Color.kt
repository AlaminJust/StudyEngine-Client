...
// Primary colors - Deep Blue for study focus
...
val SessionPlannedDark = Color(0xFF90CAF9)

val SessionInProgressLight = Color(0xFFFFA000)
val SessionInProgressDark = Color(0xFFFFCC80)
...
val SessionMissedDark = Color(0xFFEF9A9A)

val SessionCancelledLight = Color(0xFF616161)
val SessionCancelledDark = Color(0xFFBDBDBD)

// Priority colors
val PriorityHighLight = Color(0xFFD32F2F)
val PriorityHighDark = Color(0xFFEF9A9A)

val PriorityMediumLight = Color(0xFFFFA000)
val PriorityMediumDark = Color(0xFFFFCC80)
